...
OUR_SMPL_24 = {
    'L_Toe_SMPL': 0, 'L_Knee': 1, 'L_Hip': 2, 'R_Hip': 3, 'R_Knee': 4,  'R_Toe_SMPL': 5, 'L_Wrist': 6, 'L_Elbow': 7, 'L_Shoulder': 8, 'R_Shoulder': 9, \
    'R_Elbow': 10, 'R_Wrist': 11,  'Neck': 12, 'Head_top': 13, 'Pelvis': 14, 'Thorax_MPII': 15
}

OUR_SMPL_24_names = ['L_Toe_SMPL', 'L_Knee', 'L_Hip', 'R_Hip', 'R_Knee',  'R_Toe_SMPL', 'L_Wrist', 'L_Elbow', 'L_Shoulder', 'R_Shoulder', \
    'R_Elbow', 'R_Wrist',  'Neck', 'Head_top', 'Pelvis', 'Thorax_MPII']

# refer to mmdet/models/utils/smpl/smpl.py
ADS_SMPL_24 = {
    'Right Ankle':0,
    'Right Knee':1,
    'Right Hip':2,
