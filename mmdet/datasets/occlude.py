...
def occlude_with_objects(im, occluders, areas, joints, cross_prob=0.):
    ...
    for i in range(len(occluders)):
        ...
        #print('occluder shape', occluder.shape, x_jitter, y_jitter)
        #print('position', joint)
        paste_over(im_src=occluder, im_dst=result, center=joint)
