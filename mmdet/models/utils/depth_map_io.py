...
from mmdet.models.utils import get_mask_pallete
...
# def resize_depth_np(image, width=None, height=None, inter=cv2.INTER_AREA):
def resize_depth_np(image, width=None, height=None, inter=cv2.INTER_CUBIC):
