...
class FCNMaskHead(BaseModule):
    ...
    def get_targets(self, sampling_results, gt_masks, has_masks, rcnn_train_cfg):
        pos_proposals = [res.pos_bboxes for res in sampling_results]
        pos_assigned_gt_inds = [
            res.pos_assigned_gt_inds for res in sampling_results
        ]
        # mask_targets = mask_target(pos_proposals, pos_assigned_gt_inds,
        #                            gt_masks, has_masks, rcnn_train_cfg)
        # return mask_targets, None
       
        mask_targets, has_masks_targets = mask_target(pos_proposals, pos_assigned_gt_inds,
                                   gt_masks, has_masks, rcnn_train_cfg)
        return mask_targets, has_masks_targets
    ...
    def get_seg_masks(self, mask_pred, det_bboxes, det_labels, rcnn_test_cfg,
        ...
        if rescale:
            ...
            w_scale, h_scale = scale_factor[0], scale_factor[0]
