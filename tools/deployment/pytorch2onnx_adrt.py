...
def pytorch2onnx(model,
    ...
    one_meta['scale_factor'] = torch.from_numpy(one_meta['scale_factor'])
    one_meta['show_img'] = torch.from_numpy(one_meta['show_img'])
...
def parse_args():
    ...
    # parser.add_argument('--config', default="configs/smpl/ADRT_GlobalTransRoI_localFeats320_dim128_multiLayersTrans_28E_onnx.py", help='test config file path')
    ...
    # parser.add_argument('--config', default="configs/yolo/yolov3_d53_320_273e_coco.py", help='test config file path')
    # parser.add_argument('--checkpoint', default="checkpoints/yolo/yolov3_d53_320_273e_coco-421362b6.pth", help='checkpoint file')
    ...
    # parser.add_argument('--output-file', type=str, default='checkpoints/yolo/yolov3_d53_320_273e_coco-421362b6.onnx')
    parser.add_argument('--output-file', type=str, default='output/adrt.onnx')
