...
def parse_args():
    ...
    parser.add_argument('--config', default="configs/yolo/yolov3_d53_mstrain-608_273e_coco.py", help='test config file path')
    # parser.add_argument('--model', default="checkpoints/yolo/yolov3_d53_mstrain-608_273e_coco.onnx", help='Filename of input ONNX model')
    # parser.add_argument(
    #     '--trt-file',
    #     type=str,
    #     default='checkpoints/yolo/yolov3_d53_mstrain-608_273e_coco.trt',
    #     help='Filename of output TensorRT engine')
    
    parser.add_argument('--model', default="checkpoints/yolo/yolov3_d53_320_273e_coco-421362b6.onnx", help='Filename of input ONNX model')
    
    parser.add_argument(
        '--trt-file',
        type=str,
        default='checkpoints/yolo/yolov3_d53_320_273e_coco-421362b6.trt',
        help='Filename of output TensorRT engine')
    
    parser.add_argument(
        '--input-img', type=str, default='demo/demo.jpg', help='Image for test')
    parser.add_argument(
        '--show', default=True, action='store_true', help='Whether to show output results')
    parser.add_argument(
        '--dataset',
        type=str,
        default='coco',
